...
if (!found_app_adbyby() && found_app_koolproxy()) {
	var mx = { "title": "<#menu5_20#>", "link": "Advanced_koolproxy.asp" };
...
if (found_app_smartdns() && !found_app_adguardhome()){
	var mx = { "title": "<#menu5_29#>", "link": "Advanced_smartdns.asp" };
	var mx2 = [{ "title": "<#menu5_24_1#>", "link": "Advanced_smartdns.asp" }];
	menuL2.push(mx);
	tabMenuHash.put('16', mx2);
}
if (!found_app_smartdns() && found_app_adguardhome()){
	var mx = { "title": "<#menu5_29#>", "link": "Advanced_adguardhome.asp" };
...
if (found_app_aliddns() && !found_app_zerotier()){
	var mx = { "title": "<#menu5_30#>", "link": "Advanced_aliddns.asp" };
	var mx2 = [{ "title": "<#menu5_23_1#>", "link": "Advanced_aliddns.asp" }];
	menuL2.push(mx);
	tabMenuHash.put('17', mx2);
}
if (!found_app_aliddns() && found_app_zerotier()){
	var mx = { "title": "<#menu5_30#>", "link": "Advanced_zerotier.asp" };
